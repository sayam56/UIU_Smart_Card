...
String name,role,sid,uid, dept, batch;
    @Override
    ...
    public void fetch_UID(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://e624297dc64c.ngrok.io/smart_id/api_uid.php",
    ...
    public void fetch_SID(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://e624297dc64c.ngrok.io/smart_id/api_sid.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            JSONObject jsonObject = new JSONObject(response);
                            Log.d("studentidsearch","inside response sid");
                            String success = jsonObject.getString("success");
                            //String role = jsonObject.getString("role");
                            name = jsonObject.getString("name");
